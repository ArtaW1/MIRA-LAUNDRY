        ...
        <aside id="sidebar" class="sidebar-toggle" style="background-color: #1DA4FF;">
            ...
            <ul class="sidebar-nav p-0">
                <li class="sidebar-item">
                    <a href="homepageowner.php" class="sidebar-link" style="background-color: #0a7fec90;">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="datamaster" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="owner/datapelanggan.php" class="sidebar-link">Data Pelanggan</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="owner/datasupplier.php" class="sidebar-link">Data Supplier</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="owner/dataproduk.php" class="sidebar-link">Data Produk</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="owner/datapendapatan.php" class="sidebar-link">Data Pendapatan</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="owner/datapengeluaran.php" class="sidebar-link">Data Pengeluaran</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="laporan" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="owner/labarugi.php" class="sidebar-link">Laba Rugi</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="owner/neracasalso.php" class="sidebar-link">Neraca Saldo</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="owner/aruskas.php" class="sidebar-link">Arus Kas</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="owner/perubahanmodal.php" class="sidebar-link">Perubahan Modal</a>
                        </li>
                    </ul>
                </li>
            </ul>
